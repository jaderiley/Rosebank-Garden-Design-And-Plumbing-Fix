...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Rosebank Garden Design & Plumbing Fix",
    phone:     "+27 79 066 5043",
    whatsapp:  "+27 79 066 5043",
    address:   "Cradock Square, 169 Oxford Rd, Johannesburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Rosebank Garden Design & Plumbing Fix — Plumber in johannesburg",
    description: "Rosebank Garden Design & Plumbing Fix provides professional plumber in Johannesburg. 9 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "Rosebank Garden Design & Plumbing Fix provides fast, reliable plumbing services for homes and businesses across Johannesburg and the surrounding areas. Emergency callouts welcome.",
    ...
    band: {
      ...
      alt:   "Rosebank Garden Design & Plumbing Fix team at work in Johannesburg",
